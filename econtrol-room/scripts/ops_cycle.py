...
STEP_COMMANDS = [
    ...
    ('sync_db', [sys.executable, str(BASE / 'SCRIPTS' / 'sync_db.py')]),
    ...
    # Partner campaign: fetch live Brevo+DB data, run daily cycle, then render page
    ('fetch_brevo_stats', [sys.executable, str(PARTNER_BASE / 'scripts' / 'fetch_brevo_stats.py')]),
    ('partner_daily_cycle', [sys.executable, str(PARTNER_BASE / 'scripts' / 'run_daily_cycle.py')]),
