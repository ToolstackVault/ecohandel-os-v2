...
def main() -> None:
    ...
    dashboard_data_refresh = source_signals.get('dashboard_data_refresh', {})
    ...
    cron_status = {
        ...
        'dashboard_data_live_refresh': dashboard_data_refresh.get('status') == 'ok',
        'notes': 'Cron status reflects script availability and most recent generated state files. Econtrol Room is self-contained and no longer depends on ecodash-v3.',
    }
